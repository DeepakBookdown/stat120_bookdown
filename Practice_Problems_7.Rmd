...
*Question:* The standard deviation of sampling distribution has a separate name. It is called the **Standard Error**. The standard deviation of this distribution is `r sd(bootstrapped_means_df$mean)`.
<details>
<summary><red>Click for answer</red></summary>
*Answer:* It's close.
