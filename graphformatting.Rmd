...
```{r fig4, fig.cap="Figure 4: Scatterplot of price vs. carat of diamonds with color representing the cut and custom color scale."}
ggplot(data = diamonds, aes(x = carat, y = price, color = cut)) +
  geom_point(alpha = 0.5) +
  labs(title = "Price vs. Carat of Diamonds",
       subtitle = "Color represents the cut of the diamond",
...
```{r fig6, fig.cap="Figure 6: Scatterplot of mpg vs. hp with customized axis tick size."}
