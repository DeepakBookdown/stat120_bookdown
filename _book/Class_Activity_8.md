...
```
 [1] 185  23 185 185 147  87  72 147  23 132
```
...
```
 ...
 Mean of bootstrap distribution: -2.26322 
 Standard error of bootstrap distribution: 0.77692 
...
```
 ...
 Mean of bootstrap distribution: -0.03866 
 Standard error of bootstrap distribution: 0.03337 

 Bootstrap percentile interval
       2.5%       97.5% 
-0.10380952  0.02715476 
