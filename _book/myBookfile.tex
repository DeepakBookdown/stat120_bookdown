...
1   1    Hello  TRUE 249.18007
2   2    Hello FALSE  74.71655
3   3    Hello  TRUE 182.15436
4   4    Hello FALSE 210.92105
5   5    Hello  TRUE 160.48347
6   6  Goodbye FALSE 184.25925
7   7  Goodbye  TRUE  94.87006
8   8  Goodbye FALSE 219.82143
9   9  Goodbye  TRUE  79.32896
10 10  Goodbye FALSE 153.88444
\end{verbatim}
...
\begin{verbatim}
 [1] 107 268  91 187  19 191 130 221 136 194
\end{verbatim}
...
\begin{verbatim}
 [1] 125  85  72  72 125  23  93  72  93  85
\end{verbatim}
...
\begin{verbatim}
 ...
 Mean of bootstrap distribution: -2.26555 
 Standard error of bootstrap distribution: 0.77669 
...
\begin{verbatim}
 ...
 Mean of bootstrap distribution: -0.03923 
 Standard error of bootstrap distribution: 0.03352 

 Bootstrap percentile interval
       2.5%       97.5% 
-0.10380952  0.02761905 
...
\begin{verbatim}
 ...
 Mean of permutation distribution: -0.01899 
 Standard error of permutation distribution: 1.51183 
 P-value:  0.053 
...
\begin{verbatim}
 ...
 Mean of permutation distribution: 7.5676 
 Standard error of permutation distribution: 945.0632 
 P-value:  1e-04 
...
\begin{verbatim}
 ...
 Mean of permutation distribution: -0.00883 
 Standard error of permutation distribution: 1.17898 
 P-value:  2e-04 
...
\begin{verbatim}
 ...
 Standard error of permutation distribution: 1.73647 
 P-value:  2e-04 
...
\begin{verbatim}
 ...
 Standard error of permutation distribution: 0.26255 
 P-value:  0.5956 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{kableExtra}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}\FunctionTok{table}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{religiousness, survey}\SpecialCharTok{$}\NormalTok{comfortness), }
                  \AttributeTok{caption =} \StringTok{"A two way table of religious preference and political comfortness"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
...
\hypertarget{class-activity-25-1}{%
\chapter{Class Activity 25}\label{class-activity-25-1}}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Class_Activity_26_files/figure-latex/unnamed-chunk-2-1} \end{center}
