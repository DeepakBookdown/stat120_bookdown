...
1   1    Hello  TRUE 49.54584
2   2    Hello FALSE 20.33909
3   3    Hello  TRUE 53.25364
4   4    Hello FALSE 39.15167
5   5    Hello  TRUE 26.04279
6   6  Goodbye FALSE 41.13899
7   7  Goodbye  TRUE 47.57988
8   8  Goodbye FALSE 33.84054
9   9  Goodbye  TRUE 23.02700
10 10  Goodbye FALSE 56.92052
\end{verbatim}
...
\begin{verbatim}
 [1]  78  92  97  55 156 214 105 181  49 191
\end{verbatim}
...
\FunctionTok{data}\NormalTok{(}\StringTok{"forbes"}\NormalTok{)}
...
\section{Example 1: Parameters and Statistics}\label{example-1-parameters-and-statistics}}
...
\hypertarget{a.-average-household-income-for-all-houses-in-the-us-using-data-from-the-us-census}{%
\subsection{a. Average household income for all houses in the US, using data from the US census}\label{a.-average-household-income-for-all-houses-in-the-us-using-data-from-the-us-census}}

\emph{Answer:} This is a parameter since the mean is for all houses in the US, and the notation is \(\mu\).

\hypertarget{b.-the-proportion-of-all-residents-in-a-county-who-voted-in-the-last-presidential-election.}{%
\subsection{b. The proportion of all residents in a county who voted in the last presidential election.}\label{b.-the-proportion-of-all-residents-in-a-county-who-voted-in-the-last-presidential-election.}}

\emph{Answer:} This is a parameter since we have information on all the residents, and the notation is p.

\hypertarget{c.-the-difference-in-proportion-who-have-ever-smoked-cigarettes-between-a-sample-of-500-people-who-are-60-years-old-and-a-sample-of-200-people-who-are-25-years-old.}{%
\subsection{c.~The difference in proportion who have ever smoked cigarettes, between a sample of 500 people who are 60 years old and a sample of 200 people who are 25 years old.}\label{c.-the-difference-in-proportion-who-have-ever-smoked-cigarettes-between-a-sample-of-500-people-who-are-60-years-old-and-a-sample-of-200-people-who-are-25-years-old.}}
...
\hypertarget{d.-the-correlation-between-weight-and-height-for-5-year-old-kids.}{%
\subsection{d.~The correlation between weight and height for 5-year old kids.}\label{d.-the-correlation-between-weight-and-height-for-5-year-old-kids.}}

\emph{Answer:} If we are looking at all 5-year old kids it is a parameter, and the notation for correlation is \(\rho\).

\hypertarget{e.-the-mean-number-of-extracurricular-activities-from-a-random-sample-of-50-students-at-your-school.}{%
\subsection{e. The mean number of extracurricular activities from a random sample of 50 students at your school.}\label{e.-the-mean-number-of-extracurricular-activities-from-a-random-sample-of-50-students-at-your-school.}}
...
\NormalTok{p.hat}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.5898802}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{c-generate-1000-random-samples-of-size-n-100-and-plot-the-sample-proportions.}{%
\subsection{\texorpdfstring{(c) Generate 1000 random samples of size \(n= 100\) and plot the sample proportions.}{(c) Generate 1000 random samples of size n= 100 and plot the sample proportions.}}\label{c-generate-1000-random-samples-of-size-n-100-and-plot-the-sample-proportions.}}
...
\includegraphics[width=1\linewidth]{Class_Activity_7_files/figure-latex/unnamed-chunk-8-1}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.65938}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.04767482}
\end{Highlighting}
\end{Shaded}

\hypertarget{d-repeat-partc-with-sample-size-20-instead-of-100.-generate-1000-samples.}{%
\subsection{(d) Repeat part(c) with sample size 20 instead of 100. Generate 1000 samples.}\label{d-repeat-partc-with-sample-size-20-instead-of-100.-generate-1000-samples.}}
...
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(sample.prop1000)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.6606}
\FunctionTok{sd}\NormalTok{(sample.prop1000)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.1042041}
\end{Highlighting}
\end{Shaded}

\hypertarget{d-now-suppose-the-population-proportion-is-p0.90-instead-of-p0.66-in-part-e.-keep-n.size20.}{%
\subsection{\texorpdfstring{(d) Now suppose the population proportion is \(p=0.90\) instead of \(p=0.66\) in part (e). Keep n.size=20.}{(d) Now suppose the population proportion is p=0.90 instead of p=0.66 in part (e). Keep n.size=20.}}\label{d-now-suppose-the-population-proportion-is-p0.90-instead-of-p0.66-in-part-e.-keep-n.size20.}}
...
\includegraphics[width=1\linewidth]{Class_Activity_7_files/figure-latex/unnamed-chunk-13-1}
...
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(sample.prop1000)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.9014}
\FunctionTok{sd}\NormalTok{(sample.prop1000)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.06509437}
\end{Highlighting}
\end{Shaded}

\hypertarget{example-4-simulation-for-a-sample-mean}{%
\section{Example 4: Simulation for a Sample Mean}\label{example-4-simulation-for-a-sample-mean}}
...
\hypertarget{a-what-is-the-population-mean-of-the-budget}{%
\subsection{\texorpdfstring{(a) What is the population mean of the \texttt{Budget}?}{(a) What is the population mean of the Budget?}}\label{a-what-is-the-population-mean-of-the-budget}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# r{-}code}
\FunctionTok{mean}\NormalTok{(movies}\SpecialCharTok{$}\NormalTok{Budget, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{53.48134}
\end{Highlighting}
\end{Shaded}

\hypertarget{b-generate-a-random-sample-of-size-n-10-and-plot-the-sample-proportion.}{%
\subsection{\texorpdfstring{(b) Generate a random sample of size \(n= 10\) and plot the sample proportion.}{(b) Generate a random sample of size n= 10 and plot the sample proportion.}}\label{b-generate-a-random-sample-of-size-n-10-and-plot-the-sample-proportion.}}
...
\hypertarget{c-generate-5-random-samples-of-size-n-10-and-plot-the-sample-means.}{%
\subsection{\texorpdfstring{(c) Generate 5 random samples of size \(n= 10\) and plot the sample means.}{(c) Generate 5 random samples of size n= 10 and plot the sample means.}}\label{c-generate-5-random-samples-of-size-n-10-and-plot-the-sample-means.}}
...
\hypertarget{d-generate-1000-random-samples-of-size-n-10-and-plot-the-sample-means.}{%
\subsection{\texorpdfstring{(d) Generate 1000 random samples of size \(n= 10\) and plot the sample means.}{(d) Generate 1000 random samples of size n= 10 and plot the sample means.}}\label{d-generate-1000-random-samples-of-size-n-10-and-plot-the-sample-means.}}
...
\includegraphics[width=1\linewidth]{Class_Activity_7_files/figure-latex/unnamed-chunk-19-1}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{53.10596}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{15.04274}
\end{Highlighting}
\end{Shaded}

\hypertarget{e-repeat-partd-with-sample-size-50-instead-of-10.-generate-1000-samples.}{%
\subsection{(e) Repeat part(d) with sample size 50 instead of 10. Generate 1000 samples.}\label{e-repeat-partd-with-sample-size-50-instead-of-10.-generate-1000-samples.}}
...
\section{Example 5: Effect of sample size}\label{example-5-effect-of-sample-size}}
...
\includegraphics[width=1\linewidth]{Class_Activity_7_files/figure-latex/unnamed-chunk-24-1}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.09222019}
\FunctionTok{sd}\NormalTok{(data.size}\FloatTok{.100}\SpecialCharTok{$}\NormalTok{x)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.04383053}
\FunctionTok{sd}\NormalTok{(data.size}\FloatTok{.400}\SpecialCharTok{$}\NormalTok{x)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.02246123}
\end{Highlighting}
\end{Shaded}
...
\section{Example 6: Bootstrap Sampling}\label{example-6-bootstrap-sampling}}
...
\includegraphics[width=1\linewidth]{Class_Activity_7_files/figure-latex/unnamed-chunk-27-1}

\begin{enumerate}
\def\labelenumi{(\alph{enumi})}
\tightlist
\item
  Compare the center/spread/shape of the bootstrap distribution to the distribution computed in Ex. 4 (d). Answer all the questions in Ex. 4(d).
\end{enumerate}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{53.89263}
\FunctionTok{sd}\NormalTok{(mydata}\SpecialCharTok{$}\NormalTok{x)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{15.88612}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
 [1]  52 132 185 132 132  85  87  52 185  72
\end{verbatim}

\hypertarget{c-where-will-be-bootstrap-distribution-be-centered-what-shape-do-we-expect-it-to-have}{%
\subsection{(c) Where will be bootstrap distribution be centered? What shape do we expect it to have?}\label{c-where-will-be-bootstrap-distribution-be-centered-what-shape-do-we-expect-it-to-have}}
...
\hypertarget{a-what-is-the-sample-mean-what-is-the-sample-standard-deviation-use-correct-notation-for-each}{%
\subsection{(a) What is the sample mean? What is the sample standard deviation? Use correct notation for each}\label{a-what-is-the-sample-mean-what-is-the-sample-standard-deviation-use-correct-notation-for-each}}

\emph{Answer:} \(\bar{x} = 98.26\) and \(s = 0.765\).

\hypertarget{b-generate-a-bootstrap-distribution-using-at-least-1000-simulated-statistics.-what-is-the-standard}{%
\subsection{(b) Generate a bootstrap distribution, using at least 1000 simulated statistics. What is the standard}\label{b-generate-a-bootstrap-distribution-using-at-least-1000-simulated-statistics.-what-is-the-standard}}

error?

\emph{Answer:} SE \(\approx\) 0.108. Answers will vary slightly with different simulations (see output below).

\hypertarget{c-use-the-standard-error-to-find-a-95-confidence-interval.-show-your-work.-is-98.6-in-the-interval}{%
\subsection{(c) Use the standard error to find a 95\% confidence interval. Show your work. Is 98.6 in the interval?}\label{c-use-the-standard-error-to-find-a-95-confidence-interval.-show-your-work.-is-98.6-in-the-interval}}
...
\hypertarget{a-generate-1-sample-of-size-50-with-replacement-from-the-budget-variable.-if-there-are-any-na-values-they-should-be-removed-first.}{%
\subsection{\texorpdfstring{(a) Generate 1 sample of size 50 with replacement from the \texttt{Budget} variable. If there are any \texttt{NA} values, they should be removed first.}{(a) Generate 1 sample of size 50 with replacement from the Budget variable. If there are any NA values, they should be removed first.}}\label{a-generate-1-sample-of-size-50-with-replacement-from-the-budget-variable.-if-there-are-any-na-values-they-should-be-removed-first.}}
...
\hypertarget{c-generate-1000-samples-of-size-50-with-replacement-from-the-redefined-budget-variable-in-part-a.-there-are-many-methods-to-do-this.-we-will-use-lapply-function-to-do-this-simulation-faster.-using-lapply-we-can-apply-functions-to-a-list-or-vector.}{%
\subsection{\texorpdfstring{(c) Generate 1000 samples of size 50 with replacement from the redefined \texttt{Budget} variable in part (a). There are many methods to do this. We will use \texttt{lapply} function to do this simulation faster. Using \texttt{lapply} we can apply functions to a list or vector.}{(c) Generate 1000 samples of size 50 with replacement from the redefined Budget variable in part (a). There are many methods to do this. We will use lapply function to do this simulation faster. Using lapply we can apply functions to a list or vector.}}\label{c-generate-1000-samples-of-size-50-with-replacement-from-the-redefined-budget-variable-in-part-a.-there-are-many-methods-to-do-this.-we-will-use-lapply-function-to-do-this-simulation-faster.-using-lapply-we-can-apply-functions-to-a-list-or-vector.}}
...
\hypertarget{d-make-a-dotplot-of-the-1000-sample-means-calculated-in-part-c.-the-function-to-do-this-in-ggplot2-is-geom_dotplot.-there-are-two-methods-for-binning-the-data-values.-dotdensity-is-the-default-option-for-dot-density-binning-and-histodot-is-for-fixed-bin-width-like-a-histogram.}{%
\subsection{\texorpdfstring{(d) Make a dotplot of the 1000 sample means calculated in part (c). The function to do this in \texttt{ggplot2} is \texttt{geom\_dotplot}. There are two methods for binning the data values. \texttt{dotdensity} is the default option for dot-density binning and \texttt{histodot} is for fixed bin width like a histogram.}{(d) Make a dotplot of the 1000 sample means calculated in part (c). The function to do this in ggplot2 is geom\_dotplot. There are two methods for binning the data values. dotdensity is the default option for dot-density binning and histodot is for fixed bin width like a histogram.}}\label{d-make-a-dotplot-of-the-1000-sample-means-calculated-in-part-c.-the-function-to-do-this-in-ggplot2-is-geom_dotplot.-there-are-two-methods-for-binning-the-data-values.-dotdensity-is-the-default-option-for-dot-density-binning-and-histodot-is-for-fixed-bin-width-like-a-histogram.}}
...
\begin{verbatim}
 ...
 Mean of bootstrap distribution: -2.25594 
 Standard error of bootstrap distribution: 0.77532 
...
\begin{verbatim}
 ...
 Mean of bootstrap distribution: -0.03901 
 Standard error of bootstrap distribution: 0.03395 
