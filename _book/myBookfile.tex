...
1   1    Hello  TRUE 58.57286
2   2    Hello FALSE 28.26541
3   3    Hello  TRUE 30.37401
4   4    Hello FALSE 31.68727
5   5    Hello  TRUE 31.89352
6   6  Goodbye FALSE 57.80899
7   7  Goodbye  TRUE 51.66157
8   8  Goodbye FALSE 52.17688
9   9  Goodbye  TRUE 36.35211
10 10  Goodbye FALSE 40.73974
\end{verbatim}
...
\begin{verbatim}
 [1] 137  19 180 243 156 167 202 236   8 231
\end{verbatim}
...
\begin{verbatim}
 [1]  72  93 185  93  72 125  93 132  87 185
\end{verbatim}
...
\begin{verbatim}
 ...
 Mean of bootstrap distribution: -2.25776 
 Standard error of bootstrap distribution: 0.77456 
...
\begin{verbatim}
 ...
 Standard error of permutation distribution: 1.50443 
 P-value:  0.0516 
...
\begin{verbatim}
 ...
 Mean of permutation distribution: -5.96007 
 Standard error of permutation distribution: 953.288 
 P-value:  1e-04 
...
\begin{verbatim}
 ...
 Standard error of permutation distribution: 0.26334 
 P-value:  0.6026 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\DecValTok{447} \SpecialCharTok{{-}} \FloatTok{99.8}\NormalTok{)}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\FloatTok{99.8}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{pchisq}\NormalTok{(}\FloatTok{1207.894}\NormalTok{, }\AttributeTok{df =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
We can also do the test in R using the \texttt{prop.test} function. The results are slightly different due to continuity correction, but the results will be the same in most scenarios.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prop.test}\NormalTok{(}\AttributeTok{x =} \DecValTok{447}\NormalTok{, }\AttributeTok{n =} \DecValTok{998}\NormalTok{, }\AttributeTok{p =}\NormalTok{.}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prop.test}\NormalTok{(}\AttributeTok{x =} \FunctionTok{c}\NormalTok{(}\DecValTok{180}\NormalTok{, }\DecValTok{250}\NormalTok{, }\DecValTok{120}\NormalTok{, }\DecValTok{225}\NormalTok{, }\DecValTok{225}\NormalTok{), }\AttributeTok{n =} \FunctionTok{rep}\NormalTok{(}\DecValTok{1000}\NormalTok{,}\DecValTok{5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
