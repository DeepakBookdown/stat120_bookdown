...
1   1    Hello  TRUE 20.93371
2   2    Hello FALSE 49.40769
3   3    Hello  TRUE 49.52247
4   4    Hello FALSE 42.30216
5   5    Hello  TRUE 44.21130
6   6  Goodbye FALSE 37.30572
7   7  Goodbye  TRUE 49.47310
8   8  Goodbye FALSE 39.93779
9   9  Goodbye  TRUE 57.81196
10 10  Goodbye FALSE 29.35240
\end{verbatim}
...
\begin{verbatim}
 [1] 207 107 106  74  31  85 137 152 110 216
\end{verbatim}
...
\includegraphics[width=1\linewidth]{Class_Activity_5_files/figure-latex/unnamed-chunk-29-1}
...
\begin{verbatim}
 [1] 132 185 125 185  23  93  23  23  72  52
\end{verbatim}
...
\begin{verbatim}
 ...
 Mean of bootstrap distribution: -2.26105 
 Standard error of bootstrap distribution: 0.77529 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{credit}\SpecialCharTok{$}\NormalTok{Telephone }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(credit}\SpecialCharTok{$}\NormalTok{Telephone)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tapply}\NormalTok{(wordData}\SpecialCharTok{$}\NormalTok{Words, wordData}\SpecialCharTok{$}\NormalTok{Group, summary)}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
 ...
 Mean of permutation distribution: -0.01729 
 Standard error of permutation distribution: 1.51794 
 P-value:  0.0586 
...
\begin{verbatim}
 ...
 Mean of permutation distribution: -14.59988 
 Standard error of permutation distribution: 939.8083 
 P-value:  1e-04 
...
\begin{verbatim}
 ...
 Mean of permutation distribution: -0.00358 
 Standard error of permutation distribution: 0.26114 
 P-value:  0.6294 
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Make a two way table}
\NormalTok{counts }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{religiousness, survey}\SpecialCharTok{$}\NormalTok{comfortness)}
\NormalTok{counts}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{religiousness)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{comfortness)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ComfortReligion }\OtherTok{\textless{}{-}} \FunctionTok{chisq.test}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{religiousness, survey}\SpecialCharTok{$}\NormalTok{comfortness)}
\NormalTok{ComfortReligion}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ComfortReligion}\SpecialCharTok{$}\NormalTok{expected}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{chisq.test}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{religiousness, survey}\SpecialCharTok{$}\NormalTok{comfortness, }\AttributeTok{simulate.p.value =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
data:  survey$religiousness and survey$comfortness
X-squared = 19.33, df = NA, p-value = 0.002999
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{preschool.test}\SpecialCharTok{$}\NormalTok{expected}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{test3}\SpecialCharTok{$}\NormalTok{observed}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{round}\NormalTok{(test3}\SpecialCharTok{$}\NormalTok{expected,}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tapply}\NormalTok{(frisbee}\SpecialCharTok{$}\NormalTok{Distance, frisbee}\SpecialCharTok{$}\NormalTok{Grip, summary)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(frisbee}\SpecialCharTok{$}\NormalTok{Grip)  }\CommentTok{\# check n\textquotesingle{}s}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tapply}\NormalTok{(frisbee}\SpecialCharTok{$}\NormalTok{Distance, frisbee}\SpecialCharTok{$}\NormalTok{Grip, sd)  }\CommentTok{\# similar SD\textquotesingle{}s?}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tapply}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{practice\_religion, survey}\SpecialCharTok{$}\NormalTok{religiousness, summary)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tapply}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{practice\_religion, survey}\SpecialCharTok{$}\NormalTok{religiousness, sd, }\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{)  }\CommentTok{\#need na.rm with a missing value  }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(survey}\SpecialCharTok{$}\NormalTok{practice\_religion)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pairwise.t.test}\NormalTok{(Cuckoo}\SpecialCharTok{$}\NormalTok{length, Cuckoo}\SpecialCharTok{$}\NormalTok{species, }\AttributeTok{p.adjust.method =}  \StringTok{"bonferroni"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{example-1-cricket-chirps}{%
\section{Example 1: Cricket Chirps}\label{example-1-cricket-chirps}}

The data on \texttt{CricketChirps} were collected by E.A. Bessey and C.A. Bessey who measured chirp rates for crickets and temperatures during the summer of 1898. Conduct a simple linear regression analysis to predict the temperature by cricket chirp rate.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cricket }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"https://www.lock5stat.com/datasets3e/CricketChirps.csv"}\NormalTok{)}
\NormalTok{cricket}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Temperature}\SpecialCharTok{\textasciitilde{}}\NormalTok{Chirps, }\AttributeTok{data =}\NormalTok{ cricket)}
...
\hypertarget{a-what-is-the-equation-for-the-regression-line-define-all-the-variables.}{%
\subsection{(1a) What is the equation for the regression line? Define all the variables.}\label{a-what-is-the-equation-for-the-regression-line-define-all-the-variables.}}

Click for answer

\emph{Answer:} The equation for the regression line is \(\widehat{\text { Temp }}=37.7+0.23 \text{Chirps}\), where \texttt{chirps} is the cricket chirp rate and \texttt{Temp} is the temperature.

\hypertarget{b-what-is-the-standard-errorse-for-the-slope}{%
\subsection{(1b) What is the Standard Error(SE) for the slope?}\label{b-what-is-the-standard-errorse-for-the-slope}}

Click for answer

\emph{Answer:} The standard error of the slope is 0.01423.

\hypertarget{c-find-a-95-confidence-interval-for-the-slope-of-the-cricket-temperature-model.}{%
\subsection{(1c) Find a 95\% confidence interval for the slope of the cricket temperature model.}\label{c-find-a-95-confidence-interval-for-the-slope-of-the-cricket-temperature-model.}}

Click for answer

\emph{Answer:} The 95\% confidence interval for the slope is given by \(b_1 \pm t^* \cdot S E\). It can be calculated as

\[0.23067 \pm 2.57\cdot 0.01423 = (0.1940,0.2672).\]

\begin{Shaded}
\begin{Highlighting}[]
\FloatTok{0.23067} \SpecialCharTok{+} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{)}\SpecialCharTok{*} \FunctionTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\AttributeTok{df =} \DecValTok{5}\NormalTok{)}\SpecialCharTok{*} \FloatTok{0.01423}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.1940906} \FloatTok{0.2672494}
\end{Highlighting}
\end{Shaded}

\hypertarget{d-conduct-a-hypotheis-test-for-the-slope.-include-all-the-steps.}{%
\subsection{(1d) Conduct a hypotheis test for the slope. Include all the steps.}\label{d-conduct-a-hypotheis-test-for-the-slope.-include-all-the-steps.}}

Click for answer

\emph{Answer:} The hypotheses are:
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(cricket}\SpecialCharTok{$}\NormalTok{Chirps, cricket}\SpecialCharTok{$}\NormalTok{Temperature, }\AttributeTok{type =} \StringTok{"p"}\NormalTok{, }\AttributeTok{pch =} \DecValTok{19}\NormalTok{)}
...
\includegraphics[width=1\linewidth]{Class_Activity_24_files/figure-latex/unnamed-chunk-5-1}
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{2}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\FunctionTok{pt}\NormalTok{(}\FloatTok{16.21}\NormalTok{, }\AttributeTok{df =} \DecValTok{5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{e-conduct-a-hypothesis-test-to-see-if-there-exists-some-association-between-temperature-and-chirp-rate.}{%
\subsection{(1e) Conduct a hypothesis test to see if there exists some association between temperature and chirp rate.}\label{e-conduct-a-hypothesis-test-to-see-if-there-exists-some-association-between-temperature-and-chirp-rate.}}
...
\hypertarget{example-2-cereals-and-calories}{%
\section{Example 2: Cereals and Calories}\label{example-2-cereals-and-calories}}

Nutrition information for a sample of 30 breakfast cereals, derived from nutrition labels are stored under \texttt{Cereals} dataset. Calorie values are per cup of cereal and sugars are measured in grams per cup. We would like to predict the calorie count by the suger content of the cereal.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cerealdat }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"https://www.lock5stat.com/datasets3e/Cereal.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Calories}\SpecialCharTok{\textasciitilde{}}\NormalTok{Sugars, }\AttributeTok{data =}\NormalTok{ cerealdat)}
\FunctionTok{summary}\NormalTok{(mod)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{a-what-is-the-equation-for-the-regression-line-define-all-the-variables.-1}{%
\subsection{(2a) What is the equation for the regression line? Define all the variables.}\label{a-what-is-the-equation-for-the-regression-line-define-all-the-variables.-1}}

Click for answer

\emph{Answer:} \[\widehat{Calorie} = 88.92 + 4.31 \cdot \text{Sugar}\]

\hypertarget{b-check-the-conditions-for-using-linear-model.}{%
\subsection{(2b) Check the conditions for using linear model.}\label{b-check-the-conditions-for-using-linear-model.}}

Click for answer

\emph{Answer:} The assumptions for using linear model seem to have met based on the residual plot and qq-plot.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(cerealdat}\SpecialCharTok{$}\NormalTok{Sugars, cerealdat}\SpecialCharTok{$}\NormalTok{Calories, }\AttributeTok{type =} \StringTok{"p"}\NormalTok{, }\AttributeTok{pch =} \DecValTok{19}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(mod)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=1\linewidth]{Class_Activity_24_files/figure-latex/unnamed-chunk-11-1}
...
\includegraphics[width=1\linewidth]{Class_Activity_24_files/figure-latex/unnamed-chunk-12-1}
...
\includegraphics[width=1\linewidth]{Class_Activity_24_files/figure-latex/unnamed-chunk-13-1}

\hypertarget{c-conduct-a-hypotheis-test-to-determine-if-the-linear-model-is-effective.-include-all-the-steps.}{%
\subsection{(2c) Conduct a hypotheis test to determine if the linear model is effective. Include all the steps.}\label{c-conduct-a-hypotheis-test-to-determine-if-the-linear-model-is-effective.-include-all-the-steps.}}
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{2}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\FunctionTok{pt}\NormalTok{(}\FloatTok{4.650}\NormalTok{, }\AttributeTok{df =} \DecValTok{28}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{example-1-beer}{%
\section{Example 1: Beer}\label{example-1-beer}}
...
\begin{center}\includegraphics[width=0.7\linewidth]{Class_Activity_25_files/figure-latex/unnamed-chunk-2-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{confint}\NormalTok{(bac.lm)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qt}\NormalTok{(.}\DecValTok{975}\NormalTok{,}\DecValTok{14}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{a-show-how-the-test-stat-for-slope-is-computed-when-testing-h_0-beta_10-vs.-h_a-beta_1-neq-0.}{%
\subsection{\texorpdfstring{(a) Show how the test stat for slope is computed when testing \(H_0: \beta_1=0\) vs.~\(H_A: \beta_1 \neq 0\).}{(a) Show how the test stat for slope is computed when testing H\_0: \textbackslash beta\_1=0 vs.~H\_A: \textbackslash beta\_1 \textbackslash neq 0.}}\label{a-show-how-the-test-stat-for-slope-is-computed-when-testing-h_0-beta_10-vs.-h_a-beta_1-neq-0.}}

Click for answer

\emph{Answer:} The t test stat has the usual form:
...
\begin{Shaded}
\begin{Highlighting}[]
\FloatTok{0.017964}\SpecialCharTok{/}\FloatTok{0.002402}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{b-is-the-effect-of-beers-on-bac-statistically-significant}{%
\subsection{(b) Is the effect of beers on BAC statistically significant?}\label{b-is-the-effect-of-beers-on-bac-statistically-significant}}

Click for answer

\emph{Answer:} Yes, the effect of the number of beers on BAC is statistically significant (t=7.48, df=14, p\textless0.0001). The observed slope of 0.018 is 7.48 SEs away from the hypothesized slope of 0. If we repeated this experiment many times, less than 0.01\% of the time we would see an observed slope that is 7.48 SEs or more away from 0 if the true slope was 0.

\hypertarget{c-interpret-the-95-confidence-interval-for-slope-in-context.}{%
\subsection{(c) Interpret the 95\% confidence interval for slope in context.}\label{c-interpret-the-95-confidence-interval-for-slope-in-context.}}

Click for answer

\emph{Answer:} Each additional beer is associated with an average increase in BAC of 0.018 (95\% CI 0.013 to 0.023).
...
\begin{Shaded}
\begin{Highlighting}[]
\FloatTok{0.017964} \SpecialCharTok{{-}}\NormalTok{ (}\FloatTok{2.144787}\NormalTok{)}\SpecialCharTok{*}\FloatTok{0.002402}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bac.lm2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(BAC }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Beers }\SpecialCharTok{+}\NormalTok{ Weight, }\AttributeTok{data=}\NormalTok{bac)}
\FunctionTok{summary}\NormalTok{(bac.lm2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{confint}\NormalTok{(bac.lm2)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{d-what-is-the-fitted-line-for-the-multiple-regression-of-bac-on-beers-and-weight}{%
\subsection{(d) What is the fitted line for the multiple regression of BAC on Beers and Weight?}\label{d-what-is-the-fitted-line-for-the-multiple-regression-of-bac-on-beers-and-weight}}

Click for answer

\emph{Answer:} The fitted regression line is

\[
\widehat{BAC} = \hat{\mu}(BAC | weight,beers) = 0.03986 + 0.01998(Beers) - 0.0003628(Weight)
\]

\hypertarget{e-predict-the-bac-for-john-who-weighs-160-lbs-and-drank-4-beers-and-bob-who-weighs-160-lbs-and-drank-5-beers.-what-is-the-difference-in-these-predictions}{%
\subsection{(e) Predict the BAC for: John who weighs 160 lbs and drank 4 beers; and Bob who weighs 160 lbs and drank 5 beers. What is the difference in these predictions?}\label{e-predict-the-bac-for-john-who-weighs-160-lbs-and-drank-4-beers-and-bob-who-weighs-160-lbs-and-drank-5-beers.-what-is-the-difference-in-these-predictions}}

Click for answer

\emph{Answer:} John's predicted BAC is
...
\]
If John and Bob both weigh 160 pounds but Bob drank one more beer than John, then we would predict Bob's BAC to be 0.01998 units higher than John's BAC. This is exactly the coefficient value for \texttt{Beers} in the model!.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(john }\OtherTok{\textless{}{-}} \FloatTok{0.03986} \SpecialCharTok{+} \FloatTok{0.01998}\SpecialCharTok{*}\DecValTok{4} \SpecialCharTok{{-}} \FloatTok{0.0003628}\SpecialCharTok{*}\DecValTok{160}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(bob }\OtherTok{\textless{}{-}} \FloatTok{0.03986} \SpecialCharTok{+} \FloatTok{0.01998}\SpecialCharTok{*}\DecValTok{5} \SpecialCharTok{{-}} \FloatTok{0.0003628}\SpecialCharTok{*}\DecValTok{160}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bob }\SpecialCharTok{{-}}\NormalTok{ john}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{f-interpret-the-effect-of-beers-on-bac-in-context.}{%
\subsection{(f) Interpret the effect of Beers on BAC in context.}\label{f-interpret-the-effect-of-beers-on-bac-in-context.}}

Click for answer

\emph{Answer:} One more beer increases predicted BAC by 0.01998 holding weight constant.

\hypertarget{g-interpret-the-effect-of-weight-on-bac-in-context.}{%
\subsection{(g) Interpret the effect of Weight on BAC in context.}\label{g-interpret-the-effect-of-weight-on-bac-in-context.}}

Click for answer

\emph{Answer:} Holding the number of beers constant, the average BAC would be lowered by 0.00036 in we increase weight by 1 pound. Put another way, if John and Ann drank 4 beers but John weighs 30 pounds more than Ann, then we predict John's BAC to be 0.0108 (\(30 \times 0.00036\)) units lower than Ann's BAC.

\hypertarget{h-are-the-effects-of-beers-and-weight-on-bac-statistically-significant}{%
\subsection{(h) Are the effects of Beers and Weight on BAC statistically significant?}\label{h-are-the-effects-of-beers-and-weight-on-bac-statistically-significant}}

Click for answer

\emph{Answer:} Both number of beers and weight are statistically significant predictors of mean BAC (p-value \textless{} 0.0001).

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bac.lm3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(BAC }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Beers }\SpecialCharTok{+}\NormalTok{ Weight }\SpecialCharTok{+}\NormalTok{ Gender, }\AttributeTok{data=}\NormalTok{bac)}
\FunctionTok{summary}\NormalTok{(bac.lm3)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{i-predict-the-bac-for-barb-who-weighs-160-lbs-drank-4-beers-and-is-female-and-john-who-weighs-160-lbs-drank-4-beers-and-is-male.-what-is-the-difference-in-these-predictions}{%
\subsection{(i) Predict the BAC for: Barb who weighs 160 lbs, drank 4 beers and is female; and John who weighs 160 lbs, drank 4 beers and is male. What is the difference in these predictions?}\label{i-predict-the-bac-for-barb-who-weighs-160-lbs-drank-4-beers-and-is-female-and-john-who-weighs-160-lbs-drank-4-beers-and-is-male.-what-is-the-difference-in-these-predictions}}

Click for answer

\emph{Answer:} Barb's predicted BAC is
...
\]
If John and Barb both weigh 160 pounds and drank 4 beers but Barb is female and John male, then we would predict Barb's BAC to be 0.00324 units higher than John's BAC. This is exactly the coefficient value for \texttt{Gender} in the model!.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(barb }\OtherTok{\textless{}{-}} \FloatTok{0.03871} \SpecialCharTok{+} \FloatTok{0.01990}\SpecialCharTok{*}\DecValTok{4} \SpecialCharTok{{-}} \FloatTok{0.0003444}\SpecialCharTok{*}\DecValTok{160} \SpecialCharTok{{-}} \FloatTok{0.003240}\SpecialCharTok{*}\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(john }\OtherTok{\textless{}{-}} \FloatTok{0.03871} \SpecialCharTok{+} \FloatTok{0.01990}\SpecialCharTok{*}\DecValTok{4} \SpecialCharTok{{-}} \FloatTok{0.0003444}\SpecialCharTok{*}\DecValTok{160} \SpecialCharTok{{-}} \FloatTok{0.003240}\SpecialCharTok{*}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{barb }\SpecialCharTok{{-}}\NormalTok{ john}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{j-interpret-the-effect-of-gender-on-bac-in-context.}{%
\subsection{(j) Interpret the effect of Gender on BAC in context.}\label{j-interpret-the-effect-of-gender-on-bac-in-context.}}

Click for answer

\emph{Answer:} Holding weight and beers constant, we estimate that the
BAC of males is 0.0032 units lower than females on average.

\hypertarget{k-is-the-effect-of-gender-on-bac-statistically-signficant-after-accounting-for-weight-and-number-of-beers-drank}{%
\subsection{(k) Is the effect of Gender on BAC statistically signficant after accounting for weight and number of beers drank?}\label{k-is-the-effect-of-gender-on-bac-statistically-signficant-after-accounting-for-weight-and-number-of-beers-drank}}

Click for answer

\emph{Answer:} No, the p-value of 0.6155 shows that there is no
