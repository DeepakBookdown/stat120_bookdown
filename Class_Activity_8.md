...
```
 [1]  52 185  85 132 147  23 125  93  72 185
```
...
```
 ...
 Mean of bootstrap distribution: -2.26204 
 Standard error of bootstrap distribution: 0.77845 
...
```
 ...
 Mean of bootstrap distribution: -0.03946 
 Standard error of bootstrap distribution: 0.03327 

 Bootstrap percentile interval
       2.5%       97.5% 
-0.10428571  0.02571429 
